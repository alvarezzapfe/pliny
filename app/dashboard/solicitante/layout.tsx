  ...
  return (
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cb {
          ...
          background: rgba(255,255,255,.07); border: none; border-radius: 7px;
          padding: 5px; cursor: pointer; color: rgba(238,242,255,.35); flex-shrink: 0;
          transition: background .14s, color .14s;
        }
      ...
      <aside className="sb" style={{ width: W }}>
        ...
        {/* Bottom */}
        <div style={{
          padding: "8px 8px 14px", borderTop: "1px solid rgba(255,255,255,.07)",
          display: "flex", flexDirection: "column", gap: 1,
      ...
      {/* Content */}
      <div style={{
        marginLeft: W, minHeight: "100vh", background: "#F4F6FB",
