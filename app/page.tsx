    ...
    <div style={{ fontFamily: "var(--font-sans)", background: "var(--bg)", color: "var(--fg)", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <section style={{ position: "relative", zIndex: 1, paddingTop: 120 }}>
        <div className="section">
          ...
          {/* CTAs */}
          <div className={`mount mount-4`} style={{ display: "flex", justifyContent: "center", gap: 10, marginBottom: 64 }}>
            <a href="/login"    className="btn btn-solid btn-lg">Entrar a la consola →</a>
            <button className="btn btn-ghost btn-lg" onClick={() => go("pricing")}>Ver planes</button>
          </div>
          ...
          <div className={`mount mount-5 db-card scanline-wrap`} style={{ maxWidth: 960, margin: "0 auto", marginBottom: -80 }}>
            ...
            <div className="db-topbar">
              ...
              <div style={{ flex: 1, display: "flex", gap: 6, marginLeft: 12 }}>
            ...
            <div style={{ padding: "20px 16px 0" }}>
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  <div className="mono-label" style={{ marginBottom: 8 }}>Evolución · Portafolio 12M</div>
                ...
                <div style={{ display: "flex", gap: 20 }}>
                  {[["Originación","$2.8M"],["Amortiz.","$1.1M"],["Reservas","$320K"]].map(([l,v]) => (
                    <div key={l}>
                      <div className="mono-label" style={{ marginBottom: 4 }}>{l}</div>
          ...
          <div className="ticker-track">
            {[...Array(2)].map((_,ri) => (
              <span key={ri} style={{ display: "flex" }}>
                {["Onboarding digital","SAT · CFDI · ZIP","Risk signals","Scoring crediticio","Reporte PDF ejecutivo","Multi-usuario · Roles","API-first","Monitor de covenants","Alertas de mora","Integración bancaria"].map(t => (
      ...
      <section id="producto" style={{ position: "relative", zIndex: 1, padding: "100px 0 0" }}>
        <div className="section">
          <div style={{ marginBottom: 56 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40, alignItems: "end" }}>
              <h2 style={{ fontSize: "clamp(28px,4vw,44px)", fontWeight: 800, letterSpacing: "-0.04em", lineHeight: 1.05 }}>
                Todo lo que necesitas<br/>para operar crédito.
              </h2>
          ...
          {/* Feature grid — border-grid style */}
      ...
      <section id="pricing" style={{ position: "relative", zIndex: 1, padding: "100px 0" }}>
        <div className="section">
          ...
          <div className="price-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            {[
              {
                name: "Basic", price: "$70", per: "/mes USD",
                ...
                cta: "Solicitar Basic", href: "/pricing/lead?plan=basic",
                highlight: false,
              },
              {
                name: "Pro", price: "$500", per: "/mes USD",
                badge: "Recomendado",
                ...
                cta: "Solicitar Pro", href: "/pricing/lead?plan=pro",
                highlight: true,
              },
            ].map(p => (
              <div key={p.name} className={`price-card${p.highlight?" highlight":""}`}>
                {p.badge && (
                  <div style={{
                    ...
                    fontSize: 10, fontWeight: 700, fontFamily: "var(--font-mono)", letterSpacing: "0.08em",
                ...
                <a href={p.href} className={`btn btn-md ${p.highlight ? "btn-accent" : "btn-ghost"}`}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "5fr 7fr", gap: 60, alignItems: "start" }}>
              <div>
                <h2 style={{ fontSize: "clamp(24px,3.5vw,40px)", fontWeight: 800, letterSpacing: "-0.04em", lineHeight: 1.08, marginBottom: 16 }}>
                  Hecho para otorgantes.<br/><span style={{ color: "var(--fg-3)", fontWeight: 500 }}>No para todos.</span>
                </h2>
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  {["Banco","SOFOM","Fondo privado","Fintech","IFC"].map(t => (
                    <span key={t} style={{
                      ...
                      color: "var(--fg-3)", background: "rgba(255,255,255,0.05)",
        ...
        <div className="section">
          <div style={{
            ...
            <div style={{ display: "grid", gap: 8, minWidth: 300, flex: "0 0 auto" }}>
              ...
              <button className="btn btn-solid btn-md" style={{ width: "100%", marginTop: 2 }}
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                {[
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor="var(--border-2)"; e.currentTarget.style.color="var(--fg-2)"; }}
