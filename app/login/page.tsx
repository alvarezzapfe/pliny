    ...
    >
      ...
      <section
        ...
        style={{
          ...
          overflow: "hidden",
          background:
            "radial-gradient(ellipse 120% 80% at 25% 10%, #1B3F8A 0%, #0C1E4A 55%, #091530 100%)",
          padding: "40px 48px",
          display: "flex",
      ...
      >
        ...
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "linear-gradient(to bottom, transparent, rgba(91,141,239,0.04), transparent)",
        ...
        <div
          ...
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(circle, rgba(27,63,138,0.80) 0%, transparent 70%)",
          }}
        />
        <div
          className="orb-b"
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(circle, rgba(0,229,160,0.10) 0%, transparent 70%)",
          }}
        />
        {/* Noise */}
        <svg
      ...
      >
        ...
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(ellipse at top, rgba(91,141,239,0.10), transparent 70%)",
          }}
        />
                ...
                <div className="inp-wrap">
                  <div className={`inp-icon${emailFocus ? " focused" : ""}`}>
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                      <path
                        d="M1.5 3.5l6 4.5 6-4.5M1.5 3.5h12v8h-12z"
                        stroke="currentColor"
                        strokeWidth="1.2"
                        strokeLinejoin="round"
                      />
                ...
                <div className="inp-wrap">
                  ...
                  >
                    {showPass ? (
                      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                        <path
                          d="M1.5 7.5s2.5-4 6-4 6 4 6 4-2.5 4-6 4-6-4-6-4z"
                          stroke="currentColor"
                          strokeWidth="1.2"
                        />
